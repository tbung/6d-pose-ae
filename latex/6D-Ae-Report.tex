...
The reconstructions of this object with $z_{\rot}$ being 4 dimensional were not satisfying which is why decided to also train a model with $z_{\rot}$ being 64 dimensional. Both reconstructions can be seen in figure \ref{cat_images}. The vsd errors for both of these models where: XXXXXXXXXX
...
\begin{subfigure}{0.3\textwidth}
	...
	\label{cube_trec1}
\end{subfigure}
\caption{Comparision between reconstructions and targets for the two AAEs. 
